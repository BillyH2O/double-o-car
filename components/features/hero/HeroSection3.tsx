...
const HeroSection3 = ({ 
  ...
  return (
    <section 
      className="relative w-full bg-cover bg-center cn max-h-[600px] sm:max-h-[500px] md:max-h-[600px] pb-28 sm:pb-16 md:pb-36"
      style={{ backgroundImage: `url('${backgroundImage}')` }}  
    >
      
      {darkEffect && <div className="absolute inset-0 bg-black/30 z-10" />}
      <div className="relative w-full max-w-7xl mx-auto flex flex-col items-start justify-center gap-8 lg:gap-12 pt-28 sm:pt-36 md:pt-40 lg:pt-48 xl:pt-64 2xl:pt-72 px-4 sm:px-6 md:px-8 lg:px-10 xl:px-12 2xl:px-14 text-white z-20">
