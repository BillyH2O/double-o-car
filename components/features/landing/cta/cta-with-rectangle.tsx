  ...
  return (
    <section className={cn("overflow-hidden pt-0 md:pt-0", className)}>
      <div className="relative mx-auto flex max-w-container flex-col items-center gap-6 px-8 py-12 text-center sm:gap-8 md:py-24">
        ...
        {/* Title */}
        <h2 className="text-white text-3xl font-semibold sm:text-5xl opacity-0 animate-fade-in-up delay-200">
          {title}
        </h2>
        ...
        {/* Action Button */}
        <Button
          variant={action.variant as "default" | "outline" | "secondary" | "ghost" | "link" | null | undefined}
          size="lg"
