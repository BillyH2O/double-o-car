...
export const SectionTitle = ({ label, title, text, darkMode = true }: Props) => {
  ...
  return (
    <div className="relative flex flex-col items-center justify-center gap-12 w-full">
        ...
        {text && (
          <p className={`w-full sm:px-8 md:px-12 md:w-[700px] xl:w-[1250px] text-lg md:text-xl text-center ${textColor}`}>{text}</p>
        )}
      </div>
    )
}
