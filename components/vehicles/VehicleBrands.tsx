...
export default function VehicleBrands() {
  return (
    <div className="flex flex-col items-center justify-center w-full gap-4 mb-8 sm:mb-10 md:mb-12 xl:mb-14 2xl:mb-16">
        ...
        <div className="flex flex-wrap justify-center items-center gap-3 sm:gap-4 xl:gap-12 2xl:gap-12 w-full">
          {brands.map((brand) => (
